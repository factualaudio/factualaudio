...
{{% figure "plots/noisy-sine-wave" %}}
{{% figure "plots/noisy-sine-spectrum" %}}
...
{{% figure "plots/peak-frequency-response" %}}
...
{{% figure "plots/clipped-sine-wave" %}}
{{% figure "plots/clipped-sine-spectrum" %}}
