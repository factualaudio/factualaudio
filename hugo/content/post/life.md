...
{{% figure "diagrams/realms" "Audio pipeline diagram" %}}
...
{{% figure "plots/sine-wave-1khz-digital" "Digitally sampled 1kHz sine waveform" %}}
...
{{% figure "plots/sine-wave-1khz-analog" "1kHz sine wave with voltage scale" %}}
...
{{% figure "plots/sine-wave-1khz-acoustic" "1kHz sine wave with pressure scale" %}}
