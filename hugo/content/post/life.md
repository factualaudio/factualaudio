...
In the [previous post](<{{% ref "anatomy.md" %}}>), I described what an audio signal is. Now, let’s discuss how this signal is concretely represented as it passes through each stage of an audio playback system.
